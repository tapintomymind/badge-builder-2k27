 ...
 *
 * The panel chips render at the FRONT of the row (design-review P1-3 / §5.3
 * sketch): below L they are the ONLY route to Synergy/Summary, and a chip
 * that only exists past the right edge of an unafforded h-scroll is
 * functionally absent at exactly the breakpoints it exists for.
 */
